...
- Admins can use **Admin > Marble Collections** and **Admin > God Statue Categories** to assign collections to menus, toggle navbar/homepage visibility, hide collections, and set display order.
...
Use **Admin → Marble Collections** to add and manage Marble Collection menu items and homepage category cards. Use **Admin → God Statue Categories** for deity collections. Use **Admin → Featured Edits** to adjust the two large editorial cards lower on the homepage. Use **Admin → Products** to assign products to each category.
