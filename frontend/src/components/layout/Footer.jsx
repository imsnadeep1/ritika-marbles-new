...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#10221E] text-white">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href={siteConfig.socialLinks.facebook} target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#D4A853]/30 transition-colors">
