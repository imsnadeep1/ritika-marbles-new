  ...
  return (
    <section className="luxury-hero relative isolate min-h-screen overflow-hidden bg-[#090909] text-white">
      ...
      <div className="absolute bottom-[-1px] left-0 right-0 z-20 overflow-hidden">
        <div className="relative left-1/2 flex min-h-20 w-[140vw] -translate-x-1/2 items-end justify-center overflow-hidden rounded-t-[50%] bg-[#f7f1e7] px-4 pt-6 text-center shadow-[0_-18px_55px_rgba(0,0,0,0.35)] sm:min-h-24">
          <div className="pb-3">
