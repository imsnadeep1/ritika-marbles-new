...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { icon: FolderOpen, label: 'God Statue Categories', path: '/admin/categories', helper: 'God Statue menu and cards' },
    { icon: FolderOpen, label: 'Marble Collections', path: '/admin/marble-collections', helper: 'Marble menu and homepage cards' },
