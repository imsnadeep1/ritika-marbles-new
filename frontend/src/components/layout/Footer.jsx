...
const Footer = () => {
  return (
    <footer className="bg-[#1a5d4c] text-white">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-white rounded-lg flex items-center justify-center">
                <span className="text-[#1a5d4c] font-bold text-lg">R</span>
              </div>
              <div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {categories.slice(0, 6).map((category) => (
                <li key={category.id}>
                  <Link to={`/category/${category.slug}`} className="text-white/80 hover:text-white text-sm transition-colors">
                    {category.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${siteConfig.phone}`} className="text-white/80 hover:text-white text-sm transition-colors">
                  {siteConfig.phone}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 flex-shrink-0" />
                <a href={`mailto:${siteConfig.email}`} className="text-white/80 hover:text-white text-sm transition-colors">
                  {siteConfig.email}
                </a>
              </li>
            </ul>
